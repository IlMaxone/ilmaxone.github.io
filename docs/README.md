...
Questa cartella è la fonte di verità per architettura, decisioni, demo e procedure del portfolio.

- [Architettura e pubblicazione](architecture.md)
- [Demo: navigazione a costellazione](star-navigation-demo.md)
- [Sistema di contenuti: una punta per file](content-system.md)
